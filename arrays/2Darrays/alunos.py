...
for aluno in range(8):
    if aluno == 0:
        print "\033[94m|Aluno|Idade",
        for i in range(5):
            print "|%4s"  %(disciplinas[i]),
        print "|",
        print ""
    print "\033[92m| %2d  | %3d " %(aluno +1 , idadealunos[aluno]),
    for materia in range(5):
        print "\033[0m| %2d " %(prova[aluno][materia]),
    print "|",
    print ""
print "+------------------------------------------+"
...
entre18e25 = 0
for materia in range(5):
    print "\033[92m| %4s " %(disciplinas[materia]),
    for aluno in range(8):
...
for aluno in range(8):
    print "\033[92m| %2d " %(aluno+1),
    for materia in range(5):
        if prova[aluno][materia] < 3:
            print "|\033[91m %4s" %(disciplinas[materia]),
    print "|",    
    print ""
