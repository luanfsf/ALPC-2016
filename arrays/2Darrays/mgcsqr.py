...
print "\033[92m|------------------------------------------------------|"
print "\033[92m| QUADRADO MÁGICO! \o/  não escalável :-(              |"
print "\033[92m|------------------------------------------------------|"
...
while ganhou == False:
    ...
    if C1 != 15:
        print "| \033[91m%2d\033[92m" %(C1),
    else:
        print "| %2d" %(C1),
    
    if C2 != 15:
        print "| \033[91m%2d\033[92m" %(C2),
    else:
        print "| %2d" %(C2),
    ...
    print "\033[92m|------------------------------------------------------|"
    print "| Digite dois numeros para serem trocados de posição:  |",
    primeiro = 0
    segundo = 0
